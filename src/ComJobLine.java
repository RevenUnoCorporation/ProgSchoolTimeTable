...
//----------------------------------------------------------------   (-_- ) xex
        ...
        } else if (realTime >= 8.00 && realTime <= 8.40){
            realLesson = 1;

        } else if(realTime >= 8.40 && realTime <= 9.00){
            realLesson = 0;
        } else if(realTime <= 9.00 && realTime <= 9.40){
            realLesson = 2;
        }
        if(realTime >= 9.40 && realTime <= 10.00){
            realLesson = 0;
        } else if (realTime >= 10.00 && realTime <= 10.40){
            realLesson = 3;
        } else if(realTime >= 10.40 && realTime <= 11.00){
            realLesson = 0;
        } else if(realTime >= 11.00 && realTime <= 11.40){
            realLesson = 4;
        } else if(realTime >= 11.40 && realTime <= 12.00)
            realLesson = 0;
//------------------------------------------------------------- (-_- ) xex
